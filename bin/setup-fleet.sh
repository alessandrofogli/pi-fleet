...
echo "       cd ~/Documents/GitHub/<repo> && treehouse config --root ~/.treehouse"
echo "       treehouse add --target ."
echo "  3. Verifica che il modelllo di default in ~/.pi/agent/settings.json"
echo "     sia quello che vuoi per i figli (di default i figli EREDITANO"
echo "     il modello attivo del main al lancio)."
echo "  4. RIAVVIA pi (l'estensione si carica all'avvio)."
echo "  5. Prova:  guarda MiroFish e dammi un riassunto del README"
echo
